		...
		add_action(
			...
			function () {
				...
				<div class="notice notice-info is-dismissible" data-rtcl-bf-dismiss-able="rtcl_dismiss_admin_notice"
					...
					<h3 style="margin:0;"><?php echo sprintf( '%s Black Friday Sale %d!!', esc_html( $plugin_name ), $currentYear ); ?></h3>

					<p style="margin:5px 0;">
						<strong>Exciting News:</strong> Black Friday sale is now live! Get the plugin bundle or
						individual addon and enjoy discounts up to 50%. Limited time offer!!
					</p>
